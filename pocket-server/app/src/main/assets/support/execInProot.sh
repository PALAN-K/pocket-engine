...
# $LIB_PATH/busybox clear  # disabled: unnecessary in headless server mode
...
# Conditional bind mounts for Android 8-9 compatibility
APEX_BIND=""
if [ -d /apex ]; then
	APEX_BIND="-b /apex"
fi
